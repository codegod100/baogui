...
resolve_creds() {
  ...
  if [[ -z "${NIXBUILD_TOKEN:-}" ]]; then
    ...
    echo "  Scope policy example: pipeline_slug baogui-aopjch" >&2
    echo "SKIP=1"
    return 0
  fi
