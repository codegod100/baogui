...
const DEFAULT_PORT: u16 = 8250;
const LOGIN_TIMEOUT: Duration = Duration::from_secs(120);
const SUCCESS_HTML: &str = r#"<!DOCTYPE html>
<html><head><meta charset="utf-8"><title>BaoGUI</title></head>
<body style="font-family: system-ui, sans-serif; margin: 2rem;">
<h1>Authentication successful</h1>
<p>You may close this window and return to BaoGUI.</p>
</body></html>"#;
...
impl OidcLoginConfig {
    pub fn from_env_defaults() -> Self {
        ...
        if let Ok(p) = std::env::var("BAO_OIDC_PORT").or_else(|_| std::env::var("VAULT_OIDC_PORT")) {
